...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Quiz #{{ $quiz->id }}</h3>
        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('learning_unit_id') is-invalid @enderror" 
                        ...
                        @foreach($learningUnits as $unit)
                            <option value="{{ $unit->id }}" {{ old('learning_unit_id', $quiz->learning_unit_id) == $unit->id ? 'selected' : '' }}>
