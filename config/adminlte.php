...
return [
    ...
    */
    ...
    'menu' => [
        ...
        // Note: Authorization is handled by route middleware, not config closures
        // Config files load before facades are available, so we can't use auth() here
        ...
        [
            ...
            'url' => 'admin/chat-moderation',
            'icon' => 'fas fa-comments',
        ],
        
        // Smart Teacher & System Settings (Normal Admin only)
        ['header' => 'System Management'],
        [
            'text' => 'Smart Teacher',
            'url' => 'admin/smart-teacher',
            'icon' => 'fas fa-robot',
        ],
        [
